...
El sistema SHALL persistir localmente tableros, tickets, configuraciones, transiciones, ramas, ejecuciones, sesiones, logs e informes. Al reiniciar la aplicación, SHALL restaurar el estado de los tickets y su historial.

#### Scenario: Reabrir la aplicación
- **WHEN** la persona reinicia la aplicación después de registrar tickets y ejecuciones
- **THEN** el sistema SHALL mostrar el tablero y los historiales previamente almacenados
